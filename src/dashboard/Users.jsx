  ...
  const columns = [
    {
      ...
      render: (_, record) => (
        <img
          src={record.pictureUrl} // Assuming your record contains a property for the image URL
          alt="Profile"
          loading='lazy'
          style={{ width: 50, height: 50, borderRadius: '100%', position: "cover" }} // Example styling for a circular image
        />
      ),
    },
    {
      ...
      key: 'firstName',
      // width: '30%',
      ...getColumnSearchProps('fullNames'),
      sorter: (a, b) => a.firstName - b.firstName,
      sortOrder: sortedInfo.columnKey === 'fullNames' ? sortedInfo.order : null,
    },
    {
      title: 'Status',
      dataIndex: 'status',
