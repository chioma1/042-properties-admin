...
import { fetchMyUsers } from '../services/Actions';
...
export default function Settings() {
  ...
  const columns = [
    {
      ...
      sorter: (a, b) => a.businessId - b.businessId,
      sortOrder: sortedInfo.columnKey === 'businessId' ? sortedInfo.order : null,
    },
    {
      title: 'Balance',
      dataIndex: 'balance',
    ...
    },
    {
      ...
      // width: '20%',
      ...getColumnSearchProps('businessTransactionType'),
    },
    // {
    //   title: 'Paid',
    //   dataIndex: 'paid',
  ...
  const popoverContentMenu = (
    <div>
      <Card>
        <div className='flex'>
          <CSVLink filename={"Debtors-Huzz-file.csv"} data={data}>
            <Button style={{
              width: 90,
    ...
    <>
      <div className='w-1/2 m-auto flex justify-center'>
        <CardHeader color="green" contentPosition="none">
          <div className="w-full flex items-center justify-between">
            <h2 className="text-white text-2xl">Categories</h2>
            <div>
      ...
      <div className="px-3 md:px-8 h-auto -mt-24">
        ...
        <div className="grid grid-cols-1 mx-auto gap-4">
          ...
          <div className="w-full max-w-4xl mx-auto p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto">
                      ...
                      <a href="/settings" >
                        <Button
                          ...
                          style={{
                            ...
                            color: "#fff",
                            borderRadius: 6
                          }} className="ml-10 bg-042-green rounded-lg border text-white" icon={<SearchOutlined />} > View Sub Category</Button>
                      </a>
                    </div>
                  </li>
                ))}
