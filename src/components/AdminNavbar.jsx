...
export default function AdminNavbar({ showSidebar, setShowSidebar }) {
    ...
    return (
        <nav className="bg-042-green md:ml-64 py-6 px-3"><div className="container max-w-full mx-auto flex items-center justify-between md:pr-8 md:pl-10"><div className="md:hidden"><button className="false flex items-center justify-center gap-1 font-bold outline-none uppercase tracking-wider focus:outline-none focus:shadow-none transition-all duration-300 rounded-full w-12 h-12 p-0 grid place-items-center text-sm leading-relaxed bg-transparent      undefined">
